...
public class EntityListener extends ModifyworldListener {
	...
	public EntityListener(final Plugin plugin, final ConfigurationSection config, final PlayerInformer informer) {
	...
	protected void cancelDamageEvent(final Player player, final EntityDamageEvent event) {
